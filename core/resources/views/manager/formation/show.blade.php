            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select disabled class="form-control select2-multi-select" name="producteur[]" id="producteur" multiple
                                required>
                                <option value="">@lang('Selectionner une option')</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::select('formation_type', ['Cible' => 'Ciblé', 'Groupe' => 'Groupé'], null, ['placeholder' => __('Selectionner une option'), 'class' => 'form-control', 'id' => 'formation_type', 'required','disabled']); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::select('lieu_formation', ['Dans le ménage' => 'Dans le ménage', 'Place Publique' => 'Place Publique', 'Champs Ecole' => 'Champs Ecole'], $formation->lieu_formation, ['placeholder' => __('Selectionner une option'), 'class' => 'form-control', 'id' => 'lieu_formations', 'required','disabled']); ?>
                        </div>
                    </div>
                    <div class="form-group row">
                        <?php echo Form::label(__('Module de la formation'), null, ['class' => 'col-sm-4 control-label']); ?>
                        <div class="col-xs-12 col-sm-8">
                            <select disabled class="form-control select2-multi-select" name="type_formation[]" id="typeformation"
                                multiple required>
                                <option value="">@lang('Selectionner une option')</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select disabled class="form-control select2-multi-select" name="theme[]" id="theme" multiple
                                required>
                                <option value="">@lang('Selectionner une option')</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select disabled class="form-control select2-multi-select" name="sous_theme[]" id="sous_theme" multiple
                                required>
                                <option value="">@lang('Selectionner une option')</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select disabled class="form-control" name="staff" id="staff" required>
                                <option value="">@lang('Selectionner une option')</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            ...
                            ?>
                            <?php echo Form::text('multi_date', $datedebut . ' - ' . $datefin, ['class' => 'form-control', 'id' => 'multi_date','disabled','required']); ?>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8 bootstrap-timepicker timepicker">
                            <?php echo Form::text('duree_formation', $formation->duree_formation, ['class' => 'form-control', 'required' => 'required','disabled', 'placeholder' => 'Ex : 04:10']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::textarea('observation_formation', null, ['class' => 'form-control duree_formation','disabled', 'required' => 'required', 'rows' => 4]); ?>
                        </div>
                    </div>
                    <div class="form-group row">
                        <?php echo Form::label(__('Photo de la formation'), null, ['class' => 'col-sm-4 control-label']); ?>
                        <div class="col-xs-12 col-sm-8">
                            <input disabled type="file" name="photo_formation" class="form-control dropify-fr"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input disabled type="file" name="rapport_formation" class="form-control dropify-fr"
