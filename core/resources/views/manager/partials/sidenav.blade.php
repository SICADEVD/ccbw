    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                @endcan
                @if(Auth::user()->can('manager.traca.producteur.index') || Auth::user()->can('manager.traca.parcelle.index') || Auth::user()->can('manager.traca.estimation.index'))
        ...
        @endif
        @if(Auth::user()->can('manager.suivi.parcelles.index') || Auth::user()->can('manager.suivi.formation.index') || Auth::user()->can('manager.suivi.inspection.index') || Auth::user()->can('manager.suivi.application.index'))
                <li class="sidebar-menu-item sidebar-dropdown">
                ...
                @endif
                @if(Auth::user()->can('manager.livraison.stock.section') || Auth::user()->can('manager.livraison.magcentral.stock') || Auth::user()->can('manager.livraison.usine.connaissement') || Auth::user()->can('manager.livraison.prime.producteur'))
                <li class="sidebar-menu-item sidebar-dropdown">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive(['manager.communaute.action.sociale.*','manager.communaute.activite.communautaire.*'], 2) }} ">
                     ...
                     <li class="sidebar-menu-item {{ menuActive('manager.communaute.activite.communautaire.index') }}">
                                <a href="{{ route('manager.communaute.activite.communautaire.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
