                            ...
                            <div class="form-group row">
                                ...
                                <select class="form-control" name="producteur" id="producteur" required>
                                    ...
                                    @foreach($producteurs as $producteur)
                                        <option value="{{ $producteur->id }}" data-chained="{{ $producteur->localite->id }}" @selected($producteur->id==$inspection->producteur_id)>
...
<tr><td colspan="2"><strong><?php echo $catquest->titre; ?></strong></td></tr>
              ...
              <td>
                      ...
                      <option value="0"> </option>
                          ...
                          foreach($notations as $not)
                          {
                               ...
                               ?>
                             <option value="<?php echo $not->point; ?>" @selected($not->point==$q->pivot->notation)><?php echo $not->nom; ?></option>
                                            <?php
                          }
                         ?>
                      </select>
    ...
    <div class="form-group row">
        ...
        <div class="col-xs-12 col-sm-8" >
        <?php echo Form::number('note', $inspection->note, array('placeholder' => __('00'),'class' => 'form-control note', 'id'=>'note', 'readonly'=>'readonly')); ?>
        </div>
    </div>
    <div class="form-group row">
