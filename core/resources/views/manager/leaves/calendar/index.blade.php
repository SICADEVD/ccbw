    ...
    <div class="content-wrapper">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                    ...
                    <x-forms.link-primary :link="route('manager.leaves.create')"
                        data-redirect-url="{{ route('manager.leaves.calendar') }}"
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group" aria-label="Basic example">
                <a href="{{ route('manager.leaves.index') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
                    data-original-title="@lang('modules.leaves.tableView')"><i class="side-icon bi bi-list-ul"></i></a>

                <a href="{{ route('manager.leaves.calendar') }}" class="btn btn-secondary f-14 btn-active"
...
@push('scripts')
    ...
    <script>
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: {
                url: "{{ route('manager.leaves.calendar') }}",
