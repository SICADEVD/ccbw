                            ...
                            <tbody>
                                @forelse($actions as $action)
                                    <tr>
                                        ...
                                        <td> 
                                            <span>{{ diffForHumans($action->date_demarrage) }}</span>
                                        </td>
                                        <td> 
                                        ...
                                        <td>
                                        <a href="{{ route('manager.communaute.action.sociale.index', ['download'=> encrypt($action->id)]) }}" class="btn btn-sm btn--danger"><i class="la la-file-pdf-o"></i>@lang('PDF')</a>
                                        <a href="{{ route('manager.communaute.action.sociale.show', $action->id) }}"
                                        class="btn btn-sm btn-outline--info"><i class="las la-file-invoice"></i>@lang('Détail')</a>
...
@push('breadcrumb-plugins')
    ...
    <a href="{{ route('manager.communaute.action.sociale.create') }}" class="btn  btn-outline--primary h-45 addNewCooperative">
        <i class="las la-plus"></i>@lang("Ajouter nouveau")
    </a>
    <a href="{{ route('manager.communaute.action.sociale.exportExcel.actionSocialeAll') }}" class="btn  btn-outline--warning h-45"><i class="las la-cloud-download-alt"></i> Exporter en Excel</a>
@endpush
@push('style')
    <style>
        .table-responsive {
