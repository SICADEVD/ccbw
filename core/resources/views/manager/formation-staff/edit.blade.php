...
<?php use Carbon\Carbon; ?>
    ...
    <div class="form-group row">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo Form::text('lieu_formation', $formation->lieu_formation, array('placeholder' => __('Saisissez un lieu'),'class' => 'form-control', 'id'=>'lieu_formations','required'=>'required')); ?>
        </div>
    </div>
    <div class="form-group row">
