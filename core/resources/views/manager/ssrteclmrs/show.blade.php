            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select disabled class="form-control" name="producteur" id="producteur_id" required>
                                <option value="">@lang('Selectionner une option')</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::text('nomMembre', null, ['placeholder' => __('Nom du membre'), 'class' => 'form-control nomMembre', 'id' => 'nomMembre', 'required','disabled']); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::text('prenomMembre', null, ['placeholder' => __('Prenom(s) du membre'), 'class' => 'form-control prenomMembre', 'id' => 'prenomMembre', 'required','disabled']); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::select('sexeMembre', ['Homme' => __('Homme'), 'Femme' => __('Femme')], null, ['class' => 'form-control', 'required','disabled']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::date('datenaissMembre', null, ['class' => 'form-control datenaissMembre naiss', 'id' => 'datenais', 'required','disabled']); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::select('lienParente', $lienParente, null, ['placeholder' => __('Selectionner une option'), 'class' => 'form-control lienParente', 'id' => 'lienParente', 'required','disabled']); ?>
                        </div>
                    </div>
                    <div class="form-group row" id="autreLienParente">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::text('autreLienParente', null, ['placeholder' => '...', 'class' => 'form-control autreLienParente','disabled']); ?>
                        </div>
                    </div>
                    <hr class="panel-wide">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::select('frequente', ['non' => __('non'), 'oui' => __('oui')], null, ['class' => 'form-control frequente', 'required','disabled']); ?>
                        </div>
                    </div>
                    <div id="frequentation">
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <select disabled class="form-control" name="niveauEtude" id="niveauEtude">
                                    <option value="">@lang('Selectionner une option')</option>
                        ...
                        <div class="form-group row" id="classe">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                ...
                                <select disabled class="form-control" name="classe" id="classeEtude">
                                    <option value="">@lang('Selectionner une option')</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::select('ecoleVillage', ['non' => __('non'), 'oui' => __('oui')], null, ['class' => 'form-control ecoleVillage','disabled']); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="distanceEcole">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::number('distanceEcole', null, ['class' => 'form-control distanceEcole','disabled']); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::text('nomEcole', null, ['class' => 'form-control nomEcole','disabled']); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::select('moyenTransport', $moyenTransport, null, ['placeholder' => __('Selectionner une option'), 'class' => 'form-control moyenTransport', 'id' => 'moyenTransport','disabled']); ?>
                            </div>
                        </div>
                    ...
                    <div id="nonFrequentation">
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::select('avoirFrequente', ['non' => __('non'), 'oui' => __('oui')], null, ['class' => 'form-control avoirFrequente','disabled']); ?>
                            </div>
                        </div>
                        <div id="ecoleAvant">
                            ...
                            <div class="form-group row" id="niveauEtudeAtteint">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <select disabled class="form-control" name="niveauEtudeAtteint" id="niveauEtudeAtteint">
                                        <option value="">@lang('Selectionner une option')</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    ...
                                    ?>
                                    <select disabled class="form-control select2-multi-select" name="raisonArretEcole[]"
                        ...
                        <div class="form-group row" id='autreRaisonArretEcole'>
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::text('autreRaisonArretEcole', null, ['placeholder' => __('Autre raison'), 'class' => 'form-control autreRaisonArretEcole','disabled']); ?>
                            </div>
                        </div>
                    </div>
                    <hr class="panel-wide">
                    <div class="fieldset-like">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                ...
                                <select disabled class="form-control select2-multi-select" name="travauxDangereux[]"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                ...
                                <select disabled class="form-control select2-multi-select" name="lieuTravauxDangereux[]"
                    ...
                    <div class="fieldset-like">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                ...
                                <select disabled class="form-control select2-multi-select" name="travauxLegers[]"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                ...
                                <select disabled class="form-control select2-multi-select" name="lieuTravauxLegers[]"
                    ...
                    <div class="fieldset-like">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::text('nomEnqueteur', null, ['placeholder' => __('Nom de l\'enquêteur'), 'class' => 'form-control nomEnqueteur', 'id' => 'nomEnqueteur', 'required','disabled']); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::text('prenomEnqueteur', null, ['placeholder' => __('Prenom(s) de l\'enquêteur'), 'class' => 'form-control prenomEnqueteur', 'id' => 'prenomEnqueteur', 'required','disabled']); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::text('telephoneEnqueteur', null, ['placeholder' => __('Numéro de téléphone de l\'enquêteur'), 'class' => 'form-control telephoneEnqueteur', 'id' => 'telephoneEnqueteur', 'required','disabled']); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::date('date_enquete', null, ['class' => 'form-control dateactivite dateEnquete', 'required','disabled']); ?>
                        </div>
                    </div>
