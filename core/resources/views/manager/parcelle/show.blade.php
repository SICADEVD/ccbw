            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select class="form-control" name="producteur_id" id="producteur_id" required disabled>
                                <option value="">@lang('Selectionner une option')</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::select('typedeclaration', [''=>'Selectionner une option','Verbale' => __('Verbale'), 'GPS' => __('GPS')], null, ['class' => 'form-control typedeclaration', 'id' => 'typedeclaration', 'required','disabled']); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::number('anneeCreation', null, ['placeholder' => 'Année de création', 'class' => 'form-control', 'id' => 'anneeCreation', 'required', 'min' => 1990 , 'disabled']); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::number('ageMoyenCacao', null, ['placeholder' => 'Age moyen des cacaoyers', 'class' => 'form-control', 'id' => 'ageMoyenCacao', 'required','disabled']); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::select('parcelleRegenerer', ['non' => __('non'), 'oui' => __('oui')], null, ['class' => 'form-control parcelleRegenerer', 'required','disabled']); ?>
                        </div>
                    </div>
                    <div id="anneeRegenerers">
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::number('anneeRegenerer', null, ['id' => 'anneeRegenerer', 'placeholder' => 'Année de régéneration', 'class' => 'form-control anneeRegenerer','disabled']); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::number('superficieConcerne', null, ['id' => 'superficieConcerne', 'placeholder' => 'Superficie concernée', 'class' => 'form-control superficieConcerne','disabled']); ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::select('presenceCourDeau', ['non' => __('non'), 'oui' => __('oui')], null, ['class' => 'form-control presenceCourDeau', 'required','disabled']); ?>
                        </div>
                    </div>
                    <div id="courDeaus">
                        <div class="form-group row" id="">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::select('courDeau', ['Bas-fond' => 'Bas-fond', 'Marigot' => 'Marigot', 'Rivière' => 'Rivière', 'Source d’eau' => 'Source d’eau', 'Autre' => 'Autre'], null, ['id' => 'courDeau', 'class' => 'form-control courDeau','disabled']); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row" id="autreCourDeaus">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::text('autreCourDeau', null, ['class' => 'form-control autreCourDeau', 'placeholder' => 'Autre Cour ou Plan d\'eau','disabled']); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::select('existeMesureProtection', ['non' => __('non'), 'oui' => __('oui')], null, ['class' => 'form-control existeMesureProtection', 'required','disabled']); ?>
                        </div>
                    </div>
                    <div class="form-group row" id="protection">
                        <label class="col-sm-4 control-label">@lang('Sélectionner les protections')</label>
                        <div class="col-xs-12 col-sm-8">
                            <select class="form-control select2-multi-select protections" name="protection[]" multiple disabled>
                    ...
                    <div class="form-group row" id="autreProtections">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::text('autreProtection', null, ['class' => 'form-control autreProtection', 'placeholder' => 'Autre Protection', 'id' => 'autreProtection','disabled']); ?>
                        </div>
                    </div>
                    <div class="form-group row">
                        {{ Form::label(__('Ya-t-il une pente dans la Parcelle ?'), null, ['class' => 'col-sm-4 control-label']) }}
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::select('existePente', ['non' => __('non'), 'oui' => __('oui')], null, ['class' => 'form-control existePente', 'required','disabled']); ?>
                        </div>
                    </div>
                    <div class="form-group row" id="niveauPentes">
                        {{ Form::label(__('Quel est le niveau de la pente?'), null, ['class' => 'col-sm-4 control-label']) }}
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::select('niveauPente', ['Douce' => 'Douce', 'Moyenne' => 'Moyenne', 'Forte' => 'Forte'], null, ['id' => 'niveauPente', 'class' => 'form-control niveauPente','disabled']); ?>
                        </div>
                    </div>
                    <div class="form-group row">
                        {{ Form::label(__('Présence de signe d\'érosion?'), null, ['class' => 'col-sm-4 control-label']) }}
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::select('erosion', ['non' => __('non'), 'oui' => __('oui')], null, ['class' => 'form-control', 'required','disabled']); ?>
                        </div>
                    </div>
                    <div class="row mb-30">
                        <div class="col-lg-12">
                            <div class="card border--primary mt-3">
                                <h5 class="card-header bg--primary text-white">@lang('Quels sont les arbres à Ombrages observés ?')
                                    <button type="button" disabled class="btn btn-sm btn-outline-light float-end addUserData"><i
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <div class="form-group row">
                                                    ...
                                                    {!! Form::number('nbCacaoParHectare', null, [
                                                        ...
                                                        'class' => 'form-control',
                                                        'id' => 'nbCacaoParHectare-1','disabled'
                                                    ]) !!}
                                                </div>
                                            </div>
                                        </td>
