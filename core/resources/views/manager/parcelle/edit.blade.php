            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                            ...
                            <select class="form-control select2-multi-select" name="abre" id="abre" required>
                                ...
                                @foreach ($abres as $abre)
                                    {{-- <option value="{{ $abre->id }}" @selected(old('abre'))>
                                        {{ $abre->nom }}</option>  --}}
                                    <option value="{{ $abre->id }}" @if (old('abre', $abre->id) == $abre->id) selected @endif>
                                        {{ $abre->nom }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <?php
                        // Vérifiez si $abres_parcelle n'est pas vide
                        if (!$abres_parcelle->isEmpty()) {
                            $preselectedNombre = $abres_parcelle->first()->nombre;
                        } else {
                            $preselectedNombre = null;
                        }
                        ?>
                        <div class="col-xs-12 col-sm-4">
                            <?php echo Form::number('nombre', $preselectedNombre, ['placeholder' => 'Nombre', 'class' => 'form-control']); ?>
                        </div>
                    </div>
