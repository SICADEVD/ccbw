...
@section('panel')
    ...
    <div class="content-wrapper">
        ...
        <table class="table table-hover table-striped border-0 w-100 dataTable no-footer" id="employees-table">
                            <thead>
                                <tr>
                                    <th>Nom & Prenom</th>
                                    <th>Employee ID</th>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            @if($items->image)
                                                <img alt="" src="{{ url('core/storage/app/public/'. $items->image) }}">
                                            @else
                                            <img alt="" src="{{ url('assets/images/avatar.png') }}">
                                            @endif
                                            </a>
                                            <a href="{{ url('employee/profile/'.$items->user_id) }}">{{ $items->lastname }}<span>{{ $items->firstname }}</span></a>
                                        </h2>
                                    </td> 
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{ route('manager.employees.edit',$items->user_id) }}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                <a class="dropdown-item" href="{{ route('manager.employees.destroy',$items->user_id) }}"onclick="return confirm('Are you sure to want to delete it?')"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
