                ...
                <div class="card border-0 b-shadow-4 p-20 rounded">
                    <div class="card-horizontal">
                        <div class="card-header m-0 p-0 bg-white rounded">
                            <x-date-badge :month="$activity->created_at->timezone(cooperative()->timezone)->translatedFormat('M')" :date="$activity->created_at->timezone(cooperative()->timezone)->translatedFormat('d')" />
                        </div>
                        <div class="card-body border-0 p-0 ml-3">
                            ...
                            <p class="card-text f-12 text-dark-grey">
                                {{ $activity->created_at->timezone(cooperative()->timezone)->translatedFormat(cooperative()->time_format) }}
                            </p>
                        </div>
                    </div>
                </div><!-- card end -->
