...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-lg-12 mb-30">
            <div class="card">
                <div class="card-body"> 
                    {!! Form::model($localite, ['method' => 'POST','route' => ['manager.cooperative.localite.store', $localite->id],'class'=>'form-horizontal', 'id'=>'flocal', 'enctype'=>'multipart/form-data']) !!}
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <select class="form-control" name="section_id"> 
                                    @foreach ($sections as $section)
                                        <option value="{{ $section->id }}" @selected($section->id==$localite->section_id) >{{ __($section->libelle) }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::select('jourmarche', ['Lundi' => __('lundi'), 'Mardi' => __('mardi'), 'Mercredi' => __('mercredi'), 'Jeudi' => __('jeudi'), 'Vendredi' => __('vendredi'), 'Samedi' => __('samedi'), 'Dimanche' => __('dimanche')], null, ['class' => 'form-control marche']); ?>
                            </div>
                        </div>
                        <div class="form-group row" id="kmmarcheproche">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <?php echo Form::number('kmmarcheproche', null, ['placeholder' => __('nom_marche'), 'class' => 'form-control kmmarcheproche', 'min' => '0.1']); ?>
                            </div>
                        </div>
