...
<x-setting-sidebar :activeMenu="$activeSettingMenu" />
    ...
    <div id="typeModel" class="modal fade" tabindex="-1" role="dialog">
        ...
        <div class="form-group row">
            {{ Form::label(__('Nom du Categorie Questionnaire'), null, ['class' => 'control-label col-sm-4']) }}
            <div class="col-xs-12 col-sm-8 col-md-8">
            {!! Form::text('titre', null, array('placeholder' => __('Nom du Categorie Questionnaire'),'class' => 'form-control','required')) !!}
        </div>
    </div>
