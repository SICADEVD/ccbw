...
@push('breadcrumb-plugins')
    ...
    <a href="{{ route('manager.communaute.activite.communautaire.create') }}" class="btn  btn-outline--primary h-45 addNewCooperative">
        <i class="las la-plus"></i>@lang("Ajouter nouveau")
    </a>
    <a href="{{ route('manager.communaute.activite.communautaire.exportExcel.activiteCommunautaireAll') }}" class="btn  btn-outline--warning h-45"><i class="las la-cloud-download-alt"></i> Exporter en Excel</a>
@endpush
@push('style')
    <style>
        .table-responsive {
