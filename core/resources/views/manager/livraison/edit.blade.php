                    ...
                    <div class="row">
                        <div class="col-6 form-group">
                            ...
                            <div class="input-group">
                                <input name="estimate_date" value="{{ showDateTime($livraisonInfo->estimate_date,'Y-m-d')}}" type="text" autocomplete="off"  class="form-control date" placeholder="Date estimée de livraison" required>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-lg-12">
                                            ...
                                            <select class="form-control" name="sender_staff" id="sender_staff" onchange="getSender()" required>
                                                ...
                                                @selected($livraisonInfo->sender_staff_id==$staff->id)>{{__($staff->lastname)}} {{__($staff->firstname)}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label>@lang('Nom')</label>
                                            <input type="text" class="form-control" name="sender_name" value="{{ $livraisonInfo->sender_name }}" id="sender_name" required>
                                        </div>
                                        <div class=" form-group col-lg-6">
                                            <label>@lang('Contact')</label>
                                            <input type="text" class="form-control" value="{{$livraisonInfo->sender_phone}}" name="sender_phone" id="sender_phone" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <label>@lang('Email')</label>
                                            <input type="email" class="form-control" name="sender_email" id="sender_email" value="{{ $livraisonInfo->sender_email}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="sender_address"
                                                value="{{ $livraisonInfo->sender_address }}" id="sender_address" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="email" class="form-control" name="receiver_email" id="receiver_email"
                                                value="{{$livraisonInfo->receiver_email}}" required>
                                        </div>
                                        <div class="form-group col-lg-12">
                                            <label>@lang('Adresse')</label>
                                    ...
                                    <div class="row" id="addedField">
                                        <?php $i=0; ?>
                                         ...
                                         <div class="row single-item gy-2">
                                             <div class="col-md-3"> 
                                                        <select class="form-control selected_type" name="items[{{ $loop->index}}][producteur]" id='producteur-<?php echo $i; ?>' onchange=getParcelle(<?php echo $i; ?>) required>
                                                        <option disabled selected value="">@lang('Producteurs')</option>
                                                        @foreach($producteurs as $producteur)
                                                            <option value="{{$producteur->id}}"
                                                            data-id="{{$producteur->id}}" data-price={{ getAmount($campagne->prix_achat)}}
                                                ...
                                                <div class="col-md-3">
                                                    <select class="form-control selected_type" name="items[{{ $loop->index}}][parcelle]" 
                                                    id="parcelle-<?php echo $i; ?>"
                                                    required>
                                                        <option disabled selected value="">@lang('Parcelles')</option>
                                                        @foreach($parcelles as $parcelle)
                                                            <option value="{{$parcelle->id}}" @selected($item->parcelle->id==$parcelle->id) >{{ __('Parcelle')}} 
                                            ...
                                            <select class="form-control selected_type" name="items[{{ $loop->index}}][type]" required>
                                                ...
                                                <div class="col-md-7">
                                                    <select class="form-control scelleOld" name="items[{{ $loop->index}}][scelle][]" multiple> 
                                                        ...
                                                        <option value="{{ $option->numero_scelle }}" selected>{{ __($option->numero_scelle) }}</option>
                                                        @endforeach
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group">
                                                        <input type="text"  class="form-control single-item-amount" value="{{$item->fee}}"  name="items[{{ $loop->index }}][amount]" required readonly>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="discount"  class="form-control bg-white text-dark discount" value="{{ $livraisonInfo->payment->percentage }}">
