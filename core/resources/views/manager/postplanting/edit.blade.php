...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-lg-12 mb-30">
            <div class="card">
                <div class="card-body">
                    {!! Form::model($distribution, [
                        'method' => 'POST',
                        'route' => ['manager.agro.distribution.update', $distribution->id],
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 control-label"
                            style="font-weight:bold;font-size:20px;">@lang('Producteur')</label>
                        <div class="col-xs-12 col-sm-8">
                            {!! Form::text('producteurs', $distribution->producteur->nom . ' ' . $distribution->producteur->prenoms, [
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input type="number" name="total" id="total" value="{{ $total }}"
                                class="form-control" readonly style="font-weight:bold; font-size:20px;" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <?php echo Form::label(__('QUANTITE LIVREE'), null, ['class' => 'col-sm-4 control-label required', 'style' => 'font-weight:bold;font-size:20px;']); ?>
                        <div class="col-xs-12 col-sm-8">
                            <input type="number" name="qtelivre" id="qtelivre" class="form-control"
                                value="{{ $somme }}" readonly
