    ...
    <div class="content-wrapper px-4">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                <a href="{{ route('manager.hr.attendances.index') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
                    data-original-title="@lang('app.summary')"><i class="side-icon bi bi-list-ul"></i></a>

                <a href="{{ route('manager.hr.attendances.by_member') }}" class="btn btn-secondary f-14 btn-active"
...
@push('script')
    ...
    <script>
        ...
        function showTable() {
            ...
            // Refresh counts
            var url = "{{ route('manager.hr.attendances.employee_data') }}";
        ...
        $('#export-bymember').click(function() {
            ...
            var url = "{{ route('manager.hr.attendances.export_attendance', [':year', ':month', ':userId']) }}";
