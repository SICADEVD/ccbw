...
return array(
    ...
    'totalEmployeeInfo' => 'Total employees in the cooperative. Date filter not applied.',
    ...
    'probationEndDate' => "Enter the end date when the employee's probation is going to end and he/she is going to be the part of cooperative permanently",
    'noticePeriodStartDate' => 'Enter the start date when an employee is going to be in the notice period before leaving the cooperative',
    'noticePeriodEndDate' => 'Enter the end date when an employee is going to be in the notice period before leaving the cooperative',
    ...
    'cooperativeNameTooltip' => 'Add the full name of your cooperative. The cooperative name visible to the left sidebar will be changed from theme setting',
    ...
    'leave' => array(
        ...
        'noOfLeaves' => 'Number of leaves of this type given to each employee per year. For example, your cooperative may give 10 sick leaves per year',
