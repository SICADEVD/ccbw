...
class AgrodistributionController extends Controller
{
    ...
    public function index()
    {
        ...
        $manager   = auth()->user();
        $localites = Localite::active()->joinRelationship('section')->where('cooperative_id',$manager->cooperative_id)->get();
    ...
    public function edit($id)
    {
        ...
        foreach($especes as $data)
        {
            ...
            $nombre=0;
            $existe = AgrodistributionEspece::where([['agrodistribution_id',$id],
            ['agroespecesarbre_id',$data->agroespecesarbre_id]])->first();
            if($existe !=null){
                $nombre = $existe->total;
            }
